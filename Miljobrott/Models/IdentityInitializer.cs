...
namespace Miljobrott.Models
{
    public class IdentityInitializer
    {
        ...
        private static async Task CreateUsers(UserManager<IdentityUser> uManager)
        {
            ...
            await uManager.AddToRoleAsync(E001, "Coordinator"); //samord
            await uManager.AddToRoleAsync(E100, "Manager"); //chef anna
            await uManager.AddToRoleAsync(E101, "Investigator"); //handläggare
